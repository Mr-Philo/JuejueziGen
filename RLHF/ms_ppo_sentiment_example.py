...
# TODO: 从transformers改为mindnlp
from mindnlp.transforms.tokenizers import BertTokenizer, GPT2Tokenizer, ChatGLMTokenizer      # 引入特定的tokenizer，针对奖励模型和生成模型应该需要不同的tokenizer
# AutoModelForSequenceClassification类，pipeline函数在源代码仓库中用于加载预训练好的情感分析模型（作为奖励模型），此处先略过

# TODO: trl强化学习函数改用为mindspore
